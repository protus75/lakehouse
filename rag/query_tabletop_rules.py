...
def search_chromadb(
    ...
    Args:
        ...
        game_system: Filter by game system (e.g., "D&D 5e")
...
def search_duckdb(
    ...
    if game_system:
        where_clauses.append(f"f.game_system = '{game_system}'")
    if content_type:
        where_clauses.append(f"f.content_type = '{content_type}'")
...
def retrieve_context(
    ...
    semantic = search_chromadb(
        query, n_results=n_results, game_system=game_system, content_type=content_type
    )
    keyword = search_duckdb(
        query, limit=n_results, game_system=game_system, content_type=content_type
    )
...
def ask(
    ...
    Args:
        ...
        game_system: Filter results by game system (e.g., "D&D 5e")
...
if __name__ == "__main__":
    ...
    print(ask(question, game_system="D&D 5e"))
